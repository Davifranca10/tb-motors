    ...
    return (
        ...
        >
            <div className="sticky top-0 h-screen flex flex-col justify-center items-center">
                ...
                <div
                    ref={animatedVideoContainerRef}
                    className="
    absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20
    max-md:w-[100vw] max-md:h-[56vw] max-md:top-[55%]
  "
                >
                    <video
                ...
                <div className="relative z-10 text-center flex flex-col items-center mt-[350px] md:mt-[320px]">
                    <h1 className="location-content-item text-5xl sm:text-6xl md:text-7xl font-moda text-white mb-4">
                        Onde nos encontrar?
                    </h1>
                    <p className="location-content-item text-lg sm:text-xl font-poppins text-gray-300 mb-8 max-w-md px-4">
                        {address}
                    </p>
                    <a
                ...
                <div className="absolute inset-0 z-10 pointer-events-none">
                    <div className="w-full h-full relative flex justify-center items-center">
                        <div className="w-11/12 max-w-6xl h-5/6 relative">
                            <div className="top-left absolute top-0 left-0 w-24 h-24 md:w-48 md:h-48">
                            ...
                            <div className="bottom-right absolute bottom-0 right-0 w-24 h-24 md:w-48 md:h-48">
