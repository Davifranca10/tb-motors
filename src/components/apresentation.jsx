    ...
    return (
        ...
        <div id="container1-apresentation" ref={sliderRef} className="flex relative ">
            ...
            >
               ...
               xl:max-w-[100%] xl:w-[1000px] xl:mt-0 xl:h-auto xl:translate-y-[50%]"
                />
                <h1
                    id="title-exclusividade"
                    className="z-20 absolute text-ao-redor mt-[90%] xs1:mt-[40%] xl:mt-0 text-5xl xl:text-7xl font-extrabold text-center opacity-90"
                >
                    EXCLUSIVIDADE
                </h1>
                ...
                <div id="eleganciadiv" className="absolute top-10 xs2:top-5 xl:top-0 md:top-40 md:-translate-x-15 md:right-[300px] xl:right-[1180px]   ">
                    <div className="relative flex items-center justify-center">
                        <video
                            ...
                            loop
                            muted
                            className="w-[1000px] max-w-[90%] xs:max-w-[70%] xl:w-[700px] h-auto object-cover rounded-xl shadow-lg  opacity-0 relative z-0  
                            "
                        />
                        <span id="title-elegancia" className="absolute top-48 xs1:top-0 xl:top-0 inset-0 flex items-center justify-center text-white text-5xl font-bold opacity-70 z-10">
                            ELEGÂNCIA
                        </span>
                    </div>
                </div>

                <div id="paixaodiv" className="absolute xl:bottom-10 xl:left-[1180px] md:translate-x-15 md:left-[300px]  translate-y-50">
                    <div className="relative flex items-center justify-center">
                        <video
                            id="paixao"
                            ...
                            loop
                            muted
                            className="w-[1000px] max-w-[90%] xs:max-w-[70%] xl:w-[700px] h-auto object-cover rounded-xl shadow-lg -translate-y-50 opacity-0"
                        />
                        <span
                            id="title-paixao"
                            className="absolute -top-6 xs1:-top-20 md:-top-[50%] font-bold inset-0 flex items-start justify-center text-white text-5xl xl:text-7xl opacity-70"
                        >
                            PAIXÃO
                        </span>
                    </div>
            ...
            >
                ...
                <h1 id="tb1" className="font-poppins font-bold ml-23 xl:ml-0 text-[7vh] xl:text-[32vh] tracking-wider text-center orange opacity-0 xl:opacity-100">
                    TBMOTORS
                </h1>
                <h1 id="tb2" className="font-poppins font-bold ml-23 xl:ml-0 text-[7vh] xl:text-[32vh] tracking-wider text-center orange mt-110 xl:-mt-50 z-10">
                    TBMOTORS
                </h1>
                <h1 id="tb3" className="font-poppins font-bold ml-23 xl:ml-0 text-[7vh] xl:text-[32vh] tracking-wider text-center orange -mt-50 opacity-0 xl:opacity-100">
                    TBMOTORS
                </h1>
                <h2 id="subtitle-container2" className="font-poppins text-center ml-[10%] :ml-0 font-bold text-2xl xl:text-7xl relative translate-y-25 xl:-translate-y-90 opacity-0">
                    EXCLUSIVIDADE EM<span className="block xl:inline "> MOVIMENTO</span>
                </h2>
                ...
                <video
                    ...
                    loop
                    muted
                    className="z-20 absolute top-1/2 transform ml-[10%] xl:ml-0 -translate-y-1/2 w-[300px] xl:w-[900px] h-[500px] xl:h-auto object-cover rounded-xl shadow-lg opacity-100"
                />
